...
=== On macOS and Linux and Windows

. create a file named docker-compose.yml and paste the content below into it
+
[source,bash]
----
include::docker-compose.yml[]
----
. create another file named Dockerfile and paste the below content into it 
+
[source,bash]
----
include::Dockerfile[]
----
. run the commands below in the same directory where the above docker-compose.yml and Dockerfile is present
+
[source,bash]
----
docker compose up -d 
